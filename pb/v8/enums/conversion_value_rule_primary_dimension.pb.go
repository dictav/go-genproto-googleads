...
func (ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_enumTypes[0].Descriptor()
}

func (ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_enumTypes[0]
}
...
func (ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionValueRulePrimaryDimensionEnum) Reset() {
	*x = ConversionValueRulePrimaryDimensionEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_msgTypes[0]
...
func (*ConversionValueRulePrimaryDimensionEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x28, 0x43, 0x6f, 0x6e, 0x76,
...
var (
	file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescData = file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDesc
)

func file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDescData
}

var file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_goTypes = []interface{}{
	(ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension)(0), // 0: google.ads.googleads.v8.enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension
	(*ConversionValueRulePrimaryDimensionEnum)(nil),                                  // 1: google.ads.googleads.v8.enums.ConversionValueRulePrimaryDimensionEnum
}
var file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_init() }
func file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_init() {
	if File_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_goTypes,
		...
		MessageInfos:      file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto = out.File
	file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_rawDesc = nil
	file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_goTypes = nil
	file_google_ads_googleads_v8_enums_conversion_value_rule_primary_dimension_proto_depIdxs = nil
}
