...
// UnimplementedCampaignLifecycleServiceServer can be embedded to have forward compatible implementations.
...
func RegisterCampaignLifecycleServiceServer(s *grpc.Server, srv CampaignLifecycleServiceServer) {
	s.RegisterService(&_CampaignLifecycleService_serviceDesc, srv)
}
...
var _CampaignLifecycleService_serviceDesc = grpc.ServiceDesc{
