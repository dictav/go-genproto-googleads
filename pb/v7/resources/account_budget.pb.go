...
func (x *AccountBudget) Reset() {
	*x = AccountBudget{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes[0]
...
func (*AccountBudget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v7_resources_account_budget_proto_rawDescGZIP(), []int{0}
}
...
func (x *AccountBudget_PendingAccountBudgetProposal) Reset() {
	*x = AccountBudget_PendingAccountBudgetProposal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AccountBudget_PendingAccountBudgetProposal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v7_resources_account_budget_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_google_ads_googleads_v7_resources_account_budget_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v7_resources_account_budget_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v7_resources_account_budget_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v7_resources_account_budget_proto_rawDescData = file_google_ads_googleads_v7_resources_account_budget_proto_rawDesc
)

func file_google_ads_googleads_v7_resources_account_budget_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v7_resources_account_budget_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v7_resources_account_budget_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v7_resources_account_budget_proto_rawDescData)
	})
	return file_google_ads_googleads_v7_resources_account_budget_proto_rawDescData
}

var file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v7_resources_account_budget_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v7_resources_account_budget_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v7_resources_account_budget_proto_init() }
func file_google_ads_googleads_v7_resources_account_budget_proto_init() {
	if File_google_ads_googleads_v7_resources_account_budget_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v7_resources_account_budget_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v7_resources_account_budget_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v7_resources_account_budget_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v7_resources_account_budget_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v7_resources_account_budget_proto = out.File
	file_google_ads_googleads_v7_resources_account_budget_proto_rawDesc = nil
	file_google_ads_googleads_v7_resources_account_budget_proto_goTypes = nil
	file_google_ads_googleads_v7_resources_account_budget_proto_depIdxs = nil
}
