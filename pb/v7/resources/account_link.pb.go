...
func (x *AccountLink) Reset() {
	*x = AccountLink{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[0]
...
func (*AccountLink) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v7_resources_account_link_proto_rawDescGZIP(), []int{0}
}
...
func (x *ThirdPartyAppAnalyticsLinkIdentifier) Reset() {
	*x = ThirdPartyAppAnalyticsLinkIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ThirdPartyAppAnalyticsLinkIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v7_resources_account_link_proto_rawDescGZIP(), []int{1}
}
...
func (x *DataPartnerLinkIdentifier) Reset() {
	*x = DataPartnerLinkIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DataPartnerLinkIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v7_resources_account_link_proto_rawDescGZIP(), []int{2}
}
...
func (x *GoogleAdsLinkIdentifier) Reset() {
	*x = GoogleAdsLinkIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GoogleAdsLinkIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v7_resources_account_link_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v7_resources_account_link_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v7_resources_account_link_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v7_resources_account_link_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v7_resources_account_link_proto_rawDescData = file_google_ads_googleads_v7_resources_account_link_proto_rawDesc
)

func file_google_ads_googleads_v7_resources_account_link_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v7_resources_account_link_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v7_resources_account_link_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v7_resources_account_link_proto_rawDescData)
	})
	return file_google_ads_googleads_v7_resources_account_link_proto_rawDescData
}

var file_google_ads_googleads_v7_resources_account_link_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v7_resources_account_link_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v7_resources_account_link_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v7_resources_account_link_proto_init() }
func file_google_ads_googleads_v7_resources_account_link_proto_init() {
	if File_google_ads_googleads_v7_resources_account_link_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*AccountLink_ThirdPartyAppAnalytics)(nil),
		(*AccountLink_DataPartner)(nil),
		(*AccountLink_GoogleAds)(nil),
	}
	file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v7_resources_account_link_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v7_resources_account_link_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v7_resources_account_link_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v7_resources_account_link_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v7_resources_account_link_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v7_resources_account_link_proto = out.File
	file_google_ads_googleads_v7_resources_account_link_proto_rawDesc = nil
	file_google_ads_googleads_v7_resources_account_link_proto_goTypes = nil
	file_google_ads_googleads_v7_resources_account_link_proto_depIdxs = nil
}
