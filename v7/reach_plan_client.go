...
func defaultReachPlanClientOptions() []option.ClientOption {
...
// NewReachPlanClient creates a new reach plan service client.
//
...
func NewReachPlanClient(ctx context.Context, opts ...option.ClientOption) (*ReachPlanClient, error) {
	clientOpts := defaultReachPlanClientOptions()
	...
	c := &ReachPlanClient{
		...
		CallOptions:      defaultReachPlanCallOptions(),
