...
func defaultAdScheduleViewClientOptions() []option.ClientOption {
...
// NewAdScheduleViewClient creates a new ad schedule view service client.
//
...
func NewAdScheduleViewClient(ctx context.Context, opts ...option.ClientOption) (*AdScheduleViewClient, error) {
	clientOpts := defaultAdScheduleViewClientOptions()
	...
	c := &AdScheduleViewClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultAdScheduleViewCallOptions(),
