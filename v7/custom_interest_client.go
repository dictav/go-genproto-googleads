...
func defaultCustomInterestClientOptions() []option.ClientOption {
...
// NewCustomInterestClient creates a new custom interest service client.
//
...
func NewCustomInterestClient(ctx context.Context, opts ...option.ClientOption) (*CustomInterestClient, error) {
	clientOpts := defaultCustomInterestClientOptions()
	...
	c := &CustomInterestClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCustomInterestCallOptions(),
