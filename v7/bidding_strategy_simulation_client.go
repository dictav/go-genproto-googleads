...
func defaultBiddingStrategySimulationClientOptions() []option.ClientOption {
...
// NewBiddingStrategySimulationClient creates a new bidding strategy simulation service client.
//
...
func NewBiddingStrategySimulationClient(ctx context.Context, opts ...option.ClientOption) (*BiddingStrategySimulationClient, error) {
	clientOpts := defaultBiddingStrategySimulationClientOptions()
	...
	c := &BiddingStrategySimulationClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultBiddingStrategySimulationCallOptions(),
