...
func defaultAdGroupSimulationClientOptions() []option.ClientOption {
...
// NewAdGroupSimulationClient creates a new ad group simulation service client.
//
...
func NewAdGroupSimulationClient(ctx context.Context, opts ...option.ClientOption) (*AdGroupSimulationClient, error) {
	clientOpts := defaultAdGroupSimulationClientOptions()
	...
	c := &AdGroupSimulationClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultAdGroupSimulationCallOptions(),
