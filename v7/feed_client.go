...
func defaultFeedClientOptions() []option.ClientOption {
...
func NewFeedClient(ctx context.Context, opts ...option.ClientOption) (*FeedClient, error) {
	...
	c := &FeedClient{
		...
		CallOptions:      defaultFeedCallOptions(),
