...
func defaultParentalStatusViewClientOptions() []option.ClientOption {
...
// NewParentalStatusViewClient creates a new parental status view service client.
//
...
func NewParentalStatusViewClient(ctx context.Context, opts ...option.ClientOption) (*ParentalStatusViewClient, error) {
	clientOpts := defaultParentalStatusViewClientOptions()
	...
	c := &ParentalStatusViewClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultParentalStatusViewCallOptions(),
