...
func defaultCampaignCriterionClientOptions() []option.ClientOption {
...
// NewCampaignCriterionClient creates a new campaign criterion service client.
//
...
func NewCampaignCriterionClient(ctx context.Context, opts ...option.ClientOption) (*CampaignCriterionClient, error) {
	clientOpts := defaultCampaignCriterionClientOptions()
	...
	c := &CampaignCriterionClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCampaignCriterionCallOptions(),
