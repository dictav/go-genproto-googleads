...
func defaultFeedPlaceholderViewClientOptions() []option.ClientOption {
...
// NewFeedPlaceholderViewClient creates a new feed placeholder view service client.
//
...
func NewFeedPlaceholderViewClient(ctx context.Context, opts ...option.ClientOption) (*FeedPlaceholderViewClient, error) {
	clientOpts := defaultFeedPlaceholderViewClientOptions()
	...
	c := &FeedPlaceholderViewClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultFeedPlaceholderViewCallOptions(),
