...
func defaultCustomerNegativeCriterionClientOptions() []option.ClientOption {
...
// NewCustomerNegativeCriterionClient creates a new customer negative criterion service client.
//
...
func NewCustomerNegativeCriterionClient(ctx context.Context, opts ...option.ClientOption) (*CustomerNegativeCriterionClient, error) {
	clientOpts := defaultCustomerNegativeCriterionClientOptions()
	...
	c := &CustomerNegativeCriterionClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCustomerNegativeCriterionCallOptions(),
