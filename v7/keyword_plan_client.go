...
func defaultKeywordPlanClientOptions() []option.ClientOption {
...
// NewKeywordPlanClient creates a new keyword plan service client.
//
// Service to manage keyword plans.
func NewKeywordPlanClient(ctx context.Context, opts ...option.ClientOption) (*KeywordPlanClient, error) {
	clientOpts := defaultKeywordPlanClientOptions()
	...
	c := &KeywordPlanClient{
		...
		CallOptions:      defaultKeywordPlanCallOptions(),
