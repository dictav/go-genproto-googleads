...
func defaultAdGroupFeedClientOptions() []option.ClientOption {
...
// NewAdGroupFeedClient creates a new ad group feed service client.
//
...
func NewAdGroupFeedClient(ctx context.Context, opts ...option.ClientOption) (*AdGroupFeedClient, error) {
	clientOpts := defaultAdGroupFeedClientOptions()
	...
	c := &AdGroupFeedClient{
		...
		CallOptions:      defaultAdGroupFeedCallOptions(),
