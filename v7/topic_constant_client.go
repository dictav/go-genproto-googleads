...
func defaultTopicConstantClientOptions() []option.ClientOption {
...
// NewTopicConstantClient creates a new topic constant service client.
//
...
func NewTopicConstantClient(ctx context.Context, opts ...option.ClientOption) (*TopicConstantClient, error) {
	clientOpts := defaultTopicConstantClientOptions()
	...
	c := &TopicConstantClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultTopicConstantCallOptions(),
