...
func defaultAdClientOptions() []option.ClientOption {
...
func NewAdClient(ctx context.Context, opts ...option.ClientOption) (*AdClient, error) {
	...
	c := &AdClient{
		...
		CallOptions:      defaultAdCallOptions(),
