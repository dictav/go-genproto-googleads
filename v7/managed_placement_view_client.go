...
func defaultManagedPlacementViewClientOptions() []option.ClientOption {
...
// NewManagedPlacementViewClient creates a new managed placement view service client.
//
...
func NewManagedPlacementViewClient(ctx context.Context, opts ...option.ClientOption) (*ManagedPlacementViewClient, error) {
	clientOpts := defaultManagedPlacementViewClientOptions()
	...
	c := &ManagedPlacementViewClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultManagedPlacementViewCallOptions(),
