...
func defaultAdGroupCriterionLabelClientOptions() []option.ClientOption {
...
// NewAdGroupCriterionLabelClient creates a new ad group criterion label service client.
//
...
func NewAdGroupCriterionLabelClient(ctx context.Context, opts ...option.ClientOption) (*AdGroupCriterionLabelClient, error) {
	clientOpts := defaultAdGroupCriterionLabelClientOptions()
	...
	c := &AdGroupCriterionLabelClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultAdGroupCriterionLabelCallOptions(),
