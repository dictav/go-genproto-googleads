...
func defaultDynamicSearchAdsSearchTermViewClientOptions() []option.ClientOption {
...
// NewDynamicSearchAdsSearchTermViewClient creates a new dynamic search ads search term view service client.
//
...
func NewDynamicSearchAdsSearchTermViewClient(ctx context.Context, opts ...option.ClientOption) (*DynamicSearchAdsSearchTermViewClient, error) {
	clientOpts := defaultDynamicSearchAdsSearchTermViewClientOptions()
	...
	c := &DynamicSearchAdsSearchTermViewClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultDynamicSearchAdsSearchTermViewCallOptions(),
