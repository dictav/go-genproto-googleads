...
func defaultHotelPerformanceViewClientOptions() []option.ClientOption {
...
// NewHotelPerformanceViewClient creates a new hotel performance view service client.
//
...
func NewHotelPerformanceViewClient(ctx context.Context, opts ...option.ClientOption) (*HotelPerformanceViewClient, error) {
	clientOpts := defaultHotelPerformanceViewClientOptions()
	...
	c := &HotelPerformanceViewClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultHotelPerformanceViewCallOptions(),
