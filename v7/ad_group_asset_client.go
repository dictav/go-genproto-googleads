...
func defaultAdGroupAssetClientOptions() []option.ClientOption {
...
// NewAdGroupAssetClient creates a new ad group asset service client.
//
...
func NewAdGroupAssetClient(ctx context.Context, opts ...option.ClientOption) (*AdGroupAssetClient, error) {
	clientOpts := defaultAdGroupAssetClientOptions()
	...
	c := &AdGroupAssetClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultAdGroupAssetCallOptions(),
