...
func defaultRecommendationClientOptions() []option.ClientOption {
...
// NewRecommendationClient creates a new recommendation service client.
//
// Service to manage recommendations.
func NewRecommendationClient(ctx context.Context, opts ...option.ClientOption) (*RecommendationClient, error) {
	clientOpts := defaultRecommendationClientOptions()
	...
	c := &RecommendationClient{
		...
		CallOptions:      defaultRecommendationCallOptions(),
