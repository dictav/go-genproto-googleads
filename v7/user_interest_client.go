...
func defaultUserInterestClientOptions() []option.ClientOption {
...
// NewUserInterestClient creates a new user interest service client.
//
...
func NewUserInterestClient(ctx context.Context, opts ...option.ClientOption) (*UserInterestClient, error) {
	clientOpts := defaultUserInterestClientOptions()
	...
	c := &UserInterestClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultUserInterestCallOptions(),
