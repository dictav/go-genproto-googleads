...
func defaultSharedCriterionClientOptions() []option.ClientOption {
...
// NewSharedCriterionClient creates a new shared criterion service client.
//
...
func NewSharedCriterionClient(ctx context.Context, opts ...option.ClientOption) (*SharedCriterionClient, error) {
	clientOpts := defaultSharedCriterionClientOptions()
	...
	c := &SharedCriterionClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultSharedCriterionCallOptions(),
