...
func defaultMediaFileClientOptions() []option.ClientOption {
...
func NewMediaFileClient(ctx context.Context, opts ...option.ClientOption) (*MediaFileClient, error) {
	...
	c := &MediaFileClient{
		...
		CallOptions:      defaultMediaFileCallOptions(),
