...
func defaultAdGroupCriterionSimulationClientOptions() []option.ClientOption {
...
// NewAdGroupCriterionSimulationClient creates a new ad group criterion simulation service client.
//
...
func NewAdGroupCriterionSimulationClient(ctx context.Context, opts ...option.ClientOption) (*AdGroupCriterionSimulationClient, error) {
	clientOpts := defaultAdGroupCriterionSimulationClientOptions()
	...
	c := &AdGroupCriterionSimulationClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultAdGroupCriterionSimulationCallOptions(),
