...
func defaultCampaignBudgetClientOptions() []option.ClientOption {
...
// NewCampaignBudgetClient creates a new campaign budget service client.
//
...
func NewCampaignBudgetClient(ctx context.Context, opts ...option.ClientOption) (*CampaignBudgetClient, error) {
	clientOpts := defaultCampaignBudgetClientOptions()
	...
	c := &CampaignBudgetClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCampaignBudgetCallOptions(),
