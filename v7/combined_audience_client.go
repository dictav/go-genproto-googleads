...
func defaultCombinedAudienceClientOptions() []option.ClientOption {
...
// NewCombinedAudienceClient creates a new combined audience service client.
//
...
func NewCombinedAudienceClient(ctx context.Context, opts ...option.ClientOption) (*CombinedAudienceClient, error) {
	clientOpts := defaultCombinedAudienceClientOptions()
	...
	c := &CombinedAudienceClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCombinedAudienceCallOptions(),
