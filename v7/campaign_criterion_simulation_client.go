...
func defaultCampaignCriterionSimulationClientOptions() []option.ClientOption {
...
// NewCampaignCriterionSimulationClient creates a new campaign criterion simulation service client.
//
...
func NewCampaignCriterionSimulationClient(ctx context.Context, opts ...option.ClientOption) (*CampaignCriterionSimulationClient, error) {
	clientOpts := defaultCampaignCriterionSimulationClientOptions()
	...
	c := &CampaignCriterionSimulationClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCampaignCriterionSimulationCallOptions(),
