...
func defaultCarrierConstantClientOptions() []option.ClientOption {
...
// NewCarrierConstantClient creates a new carrier constant service client.
//
...
func NewCarrierConstantClient(ctx context.Context, opts ...option.ClientOption) (*CarrierConstantClient, error) {
	clientOpts := defaultCarrierConstantClientOptions()
	...
	c := &CarrierConstantClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCarrierConstantCallOptions(),
