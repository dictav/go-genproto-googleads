...
func defaultWebpageViewClientOptions() []option.ClientOption {
...
// NewWebpageViewClient creates a new webpage view service client.
//
...
func NewWebpageViewClient(ctx context.Context, opts ...option.ClientOption) (*WebpageViewClient, error) {
	clientOpts := defaultWebpageViewClientOptions()
	...
	c := &WebpageViewClient{
		...
		CallOptions:      defaultWebpageViewCallOptions(),
