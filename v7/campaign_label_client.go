...
func defaultCampaignLabelClientOptions() []option.ClientOption {
...
// NewCampaignLabelClient creates a new campaign label service client.
//
...
func NewCampaignLabelClient(ctx context.Context, opts ...option.ClientOption) (*CampaignLabelClient, error) {
	clientOpts := defaultCampaignLabelClientOptions()
	...
	c := &CampaignLabelClient{
		connPool:         connPool,
		disableDeadlines: disableDeadlines,
		CallOptions:      defaultCampaignLabelCallOptions(),
